...
async function execute(client, interaction) {
    ...
    if (!interaction.member.permissions.has(Permissions.FLAGS.MANAGE_CHANNELS)) {
        interaction.reply(':x: Sorry, this command is reserved for thos with the `MANAGE_CHANNELS` permissions only!');
        return;
    }
...
module.exports = {
    data: new SlashCommandBuilder().setName('setup-counting').setDescription('Used to setup a counting channel in your guild!')
